...
cp -r web3/evm-nft-mint-bot ~/.hermes/skills/web3/evm-nft-mint-bot/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/evm-nft-mint-bot-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/evm-nft-mint-bot-skill.git ~/.hermes/skills/web3/evm-nft-mint-bot/
```
...
```text
skill_view(name="web3/evm-nft-mint-bot")
```
...
```text
Use the evm nft mint bot skill to <describe your specific task here>
```
...
```text
Gunakan skill evm nft mint bot untuk <deskripsikan tugas spesifik Anda di sini>
```
